...
type
    ...
    TSetVerify_cb = function(Ok: Integer; StoreCtx: PX509_STORE)
      : Integer; cdecl;
    ...
    TDynLockCreateCallback = function(const _File: MarshaledAString;
      Line: Integer): PCRYPTO_dynlock_value; cdecl;
    TDynLockLockCallback = procedure(Mode: Integer; L: PCRYPTO_dynlock_value;
      _File: MarshaledAString; Line: Integer); cdecl;
    TDynLockDestroyCallback = procedure(L: PCRYPTO_dynlock_value;
      _File: MarshaledAString; Line: Integer); cdecl;
    TPemPasswordCallback = function(buf: Pointer; size: Integer;
      rwflag: Integer; userdata: Pointer): Integer; cdecl;

var
    SSL_library_init: function: Integer;
cdecl = nil;
...
cdecl = nil;
SSL_CTX_free:
procedure(ctx: PSSL_CTX);
cdecl = nil;
SSL_CTX_set_verify:
procedure(ctx: PSSL_CTX; Mode: Integer; callback: TSetVerify_cb);
cdecl = nil;
SSL_CTX_use_PrivateKey:
function(ctx: PSSL_CTX; pkey: PEVP_PKEY): Integer;
cdecl = nil;
SSL_CTX_use_RSAPrivateKey:
function(ctx: PSSL_CTX; pkey: PEVP_PKEY): Integer;
cdecl = nil;
SSL_CTX_use_certificate:
function(ctx: PSSL_CTX; x: PX509): Integer;
cdecl = nil;
SSL_CTX_check_private_key:
function(ctx: PSSL_CTX): Integer;
cdecl = nil;
SSL_CTX_use_certificate_file:
function(ctx: PSSL_CTX; f: MarshaledAString; t: Integer): Integer;
cdecl = nil;
SSL_CTX_use_RSAPrivateKey_file:
function(ctx: PSSL_CTX; f: MarshaledAString; t: Integer): Integer;
cdecl = nil;
SSL_CTX_get_cert_store:
function(ctx: PSSL_CTX): PX509_STORE;
cdecl = nil;
SSL_CTX_ctrl:
function(ctx: PSSL_CTX; cmd, i: Integer; p: Pointer): Integer;
cdecl = nil;
SSL_CTX_load_verify_locations:
function(ctx: PSSL_CTX; CAFile: MarshaledAString;
  CAPath: MarshaledAString): Integer;
cdecl = nil;
SSL_CTX_use_certificate_chain_file:
function(ctx: PSSL_CTX; CAFile: MarshaledAString): Integer;
cdecl = nil;
SSL_CTX_set_alpn_protos:
function(ctx: PSSL_CTX; protos: MarshaledAString; protos_len: Integer): Integer;
cdecl = nil;
SSL_new:
function(ctx: PSSL_CTX): PSSL;
cdecl = nil;
SSL_set_bio:
procedure(s: PSSL; rbio, wbio: PBIO);
cdecl = nil;
SSL_get_peer_certificate:
function(s: PSSL): PX509;
cdecl = nil;
SSL_get_error:
function(s: PSSL; ret_code: Integer): Integer;
cdecl = nil;
SSL_shutdown:
...
cdecl = nil;
SSL_set_cipher_list:
function(s: PSSL; ciphers: MarshaledAString): Integer;
cdecl = nil;
SSL_get0_alpn_selected:
procedure(s: PSSL; out data: MarshaledAString; out len: Integer);
cdecl = nil;
SSL_clear:
function(s: PSSL): Integer;
cdecl = nil;
SSL_ctrl:
function(s: PSSL; cmd: Integer; larg: LongInt; parg: Pointer): Integer;
cdecl = nil;
CRYPTO_num_locks:
function: Integer;
cdecl = nil;
CRYPTO_set_locking_callback:
procedure(callback: TStatLockLockCallback);
cdecl = nil;
CRYPTO_set_dynlock_create_callback:
procedure(callback: TDynLockCreateCallback);
cdecl = nil;
CRYPTO_set_dynlock_lock_callback:
procedure(callback: TDynLockLockCallback);
cdecl = nil;
CRYPTO_set_dynlock_destroy_callback:
procedure(callback: TDynLockDestroyCallback);
cdecl = nil;
CRYPTO_cleanup_all_ex_data:
procedure;
cdecl = nil;
ERR_remove_state:
procedure(tid: Cardinal);
cdecl = nil;
ERR_free_strings:
procedure;
cdecl = nil; // thread-unsafe, Application-global cleanup functions
ERR_error_string_n:
procedure(err: Cardinal; buf: MarshaledAString; len: NativeUInt);
cdecl = nil;
ERR_get_error:
function: Cardinal;
cdecl = nil;
ERR_remove_thread_state:
procedure(pid: Cardinal);
cdecl = nil;
...
cdecl = nil;
BIO_new_socket:
function(sock: Integer; close_flag: Integer): PBIO;
cdecl = nil;
...
cdecl = nil;
X509_free:
procedure(cert: PX509);
cdecl = nil;
X509_NAME_print_ex:
function(bout: PBIO; nm: PX509_NAME; indent: Integer; flags: Cardinal): Integer;
cdecl = nil;
sk_num:
function(stack: PSTACK): Integer;
cdecl = nil;
sk_pop:
function(stack: PSTACK): Pointer;
cdecl = nil;
ASN1_BIT_STRING_get_bit:
function(a: PASN1_BIT_STRING; N: Integer): Integer;
cdecl = nil;
OBJ_obj2nid:
function(o: PASN1_OBJECT): Integer;
cdecl = nil;
OBJ_nid2sn:
function(N: Integer): MarshaledAString;
cdecl = nil;
ASN1_STRING_data:
function(x: PASN1_STRING): Pointer;
cdecl = nil;
PEM_read_bio_X509:
function(bp: PBIO; x: PX509; cb: TPemPasswordCallback; u: Pointer): PX509;
cdecl = nil;
PEM_read_bio_PrivateKey:
function(bp: PBIO; x: PPEVP_PKEY; cb: TPemPasswordCallback; u: Pointer)
  : PEVP_PKEY;
cdecl = nil;
...
cdecl = nil;
EVP_PKEY_size:
function(key: PEVP_PKEY): Integer;
cdecl = nil;
EVP_DigestSignInit:
function(aCtx: PEVP_MD_CTX; aPCtx: PEVP_PKEY_CTX; aType: PEVP_MD;
  aEngine: PENGINE; aKey: PEVP_PKEY): Integer;
cdecl = nil;
EVP_DigestUpdate:
function(ctx: PEVP_MD_CTX; const d: Pointer; cnt: Cardinal): Integer;
cdecl = nil;
EVP_DigestSignFinal:
function(ctx: PEVP_MD_CTX; const d: PByte; var cnt: Cardinal): Integer;
cdecl = nil;
...
function(ctx: PEVP_MD_CTX; const d: PByte; cnt: Cardinal): Integer;
cdecl = nil;
CRYPTO_malloc:
function(aLength: LongInt; const f: MarshaledAString; aLine: Integer): Pointer;
cdecl = nil;
CRYPTO_free:
procedure(str: Pointer);
cdecl = nil;
HMAC:
function(evp: PEVP_MD; key: PByte; key_len: Integer; data: PByte;
  data_len: Integer; md: PByte; var md_len: Integer): PByte;
cdecl = nil;
...
function SSLError(const ASSL: PSSL; const AReturnCode: Integer;
  out AErrorMsg: String): Integer;
...
begin
    Result := PInteger(MarshaledAString(ABIO) + 3 * SizeOf(Pointer) + 2 *
      SizeOf(Integer))^;
end;
...
begin
    Result := SSL_ctrl(s, SSL_CTRL_SET_TLSEXT_HOSTNAME,
      TLSEXT_NAMETYPE_host_name, M.AsAnsi(name).ToPointer);
end;
...
begin
    ...
    try
        ...
        SSL_load_error_strings := GetProc(_SSLEAYHandle,
          'SSL_load_error_strings');
        ...
        SSL_CTX_use_PrivateKey := GetProc(_SSLEAYHandle,
          'SSL_CTX_use_PrivateKey');
        SSL_CTX_use_RSAPrivateKey := GetProc(_SSLEAYHandle,
          'SSL_CTX_use_RSAPrivateKey');
        SSL_CTX_use_certificate := GetProc(_SSLEAYHandle,
          'SSL_CTX_use_certificate');
        SSL_CTX_check_private_key := GetProc(_SSLEAYHandle,
          'SSL_CTX_check_private_key');
        SSL_CTX_use_certificate_file :=
          GetProc(_SSLEAYHandle, 'SSL_CTX_use_certificate_file');
        SSL_CTX_use_RSAPrivateKey_file :=
          GetProc(_SSLEAYHandle, 'SSL_CTX_use_RSAPrivateKey_file');
        SSL_CTX_get_cert_store := GetProc(_SSLEAYHandle,
          'SSL_CTX_get_cert_store');
        SSL_CTX_ctrl := GetProc(_SSLEAYHandle, 'SSL_CTX_ctrl');
        SSL_CTX_load_verify_locations :=
          GetProc(_SSLEAYHandle, 'SSL_CTX_load_verify_locations');
        SSL_CTX_use_certificate_chain_file :=
          GetProc(_SSLEAYHandle, 'SSL_CTX_use_certificate_chain_file');
        SSL_CTX_set_alpn_protos := GetProc(_SSLEAYHandle,
          'SSL_CTX_set_alpn_protos');
        SSL_new := GetProc(_SSLEAYHandle, 'SSL_new');
        SSL_set_bio := GetProc(_SSLEAYHandle, 'SSL_set_bio');
        SSL_get_peer_certificate := GetProc(_SSLEAYHandle,
          'SSL_get_peer_certificate');
        ...
        SSL_set_connect_state := GetProc(_SSLEAYHandle,
          'SSL_set_connect_state');
        ...
        SSL_get0_alpn_selected := GetProc(_SSLEAYHandle,
          'SSL_get0_alpn_selected');
...
begin
    ...
    CRYPTO_set_locking_callback := GetProc(_LIBEAYHandle,
      'CRYPTO_set_locking_callback');
    CRYPTO_set_dynlock_create_callback :=
      GetProc(_LIBEAYHandle, 'CRYPTO_set_dynlock_create_callback');
    CRYPTO_set_dynlock_lock_callback :=
      GetProc(_LIBEAYHandle, 'CRYPTO_set_dynlock_lock_callback');
    CRYPTO_set_dynlock_destroy_callback :=
      GetProc(_LIBEAYHandle, 'CRYPTO_set_dynlock_destroy_callback');
    CRYPTO_cleanup_all_ex_data := GetProc(_LIBEAYHandle,
      'CRYPTO_cleanup_all_ex_data');
    ...
    ERR_remove_thread_state := GetProc(_LIBEAYHandle,
      'ERR_remove_thread_state');
    ...
    ASN1_BIT_STRING_get_bit := GetProc(_LIBEAYHandle,
      'ASN1_BIT_STRING_get_bit');
    ...
    PEM_read_bio_PrivateKey := GetProc(_LIBEAYHandle,
      'PEM_read_bio_PrivateKey');
    PEM_read_bio_RSAPrivateKey := GetProc(_LIBEAYHandle,
      'PEM_read_bio_RSAPrivateKey');
...
procedure CRYPTO_locking_callback(Mode, N: Integer;
  const _File: MarshaledAString; Line: Integer); cdecl;
begin
...
procedure CRYPTO_dynlock_callback_lock(Mode: Integer; L: PCRYPTO_dynlock_value;
  _File: MarshaledAString; Line: Integer); cdecl;
begin
    if (Mode and CRYPTO_LOCK <> 0) then
        L.Mutex.Enter
...
function CRYPTO_dynlock_callback_create(const _File: MarshaledAString;
  Line: Integer): PCRYPTO_dynlock_value; cdecl;
begin
    New(Result);
...
procedure CRYPTO_dynlock_callback_destroy(L: PCRYPTO_dynlock_value;
  _File: MarshaledAString; Line: Integer); cdecl;
begin
    L.Mutex.Free;
    Dispose(L);
