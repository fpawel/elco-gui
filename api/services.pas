...
type
    ...
    TRunnerSvc = class
    public
        class procedure RunMainWork(param1: Boolean; param2: Boolean;
          param3: Boolean; param4: Boolean; param5: Boolean);
...
begin
    ...
    resp := Pipe_GetJsonrpcResult(pipe_conn,
      'SettingsSvc.ChangePredefined', req);
...
begin
    ...
    resp := Pipe_GetJsonrpcResult(pipe_conn,
      'SettingsSvc.SetDefaultPredefined', req);
...
class procedure TRunnerSvc.RunMainWork(param1: Boolean; param2: Boolean;
  param3: Boolean; param4: Boolean; param5: Boolean);
var
    req, resp: ISuperobject;
begin
    ...
    resp := Pipe_GetJsonrpcResult(pipe_conn, 'RunnerSvc.RunMainWork', req);
