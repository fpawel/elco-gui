...
type
    ...
    public
        ...
        class procedure DeleteDay(param1: Integer; param2: Integer;
          param3: Integer);
    ...
    public
        ...
        class function SetPointsMethodAtPlace(Place: Integer;
          PointsMethod: Int64; Valid: Boolean): Int64;
    ...
    public
        ...
        class procedure RunWritePlaceFirmware(Place: Integer; Year: Integer;
          Month: Integer; Day: Integer; Hour: Integer; Minute: Integer;
          Second: Integer; Sensitivity: string; Serial: string;
          ProductType: string; Gas: string; Units: string; ScaleBegin: string;
          ScaleEnd: string; Values: TArray<string>);
    ...
    public
        ...
        class procedure SetValue(param1: string; param2: string;
          param3: string);
    ...
    public
        ...
        class procedure RunReadCurrent(param1: Boolean; param2: Boolean;
          param3: Boolean; param4: Boolean; param5: Boolean; param6: Boolean;
          param7: Boolean; param8: Boolean; param9: Boolean; param10: Boolean;
          param11: Boolean; param12: Boolean);
        class procedure RunTemperature(param1: Boolean; param2: Boolean;
          param3: Boolean);
    ...
    TJournal = class
    public
        class function DayEntries(Year: Integer; Month: Integer; Day: Integer)
          : TArray<TJournalEntry>;
        class function DayWorks(Year: Integer; Month: Integer; Day: Integer)
          : TArray<TJournalWork>;
        class function Days(Year: Integer; Month: Integer): TArray<Integer>;
...
class procedure TPartiesCatalogue.DeleteDay(param1: Integer; param2: Integer;
  param3: Integer);
var
    req, resp: ISuperobject;
begin
...
begin
    ...
    resp := Pipe_GetJsonrpcResult(pipe_conn,
      'PartiesCatalogue.DeleteMonth', req);
...
begin
    ...
    resp := Pipe_GetJsonrpcResult(pipe_conn,
      'PartiesCatalogue.DeletePartyID', req);
...
begin
    ...
    resp := Pipe_GetJsonrpcResult(pipe_conn,
      'PartiesCatalogue.DeleteYear', req);
...
class function TLastParty.SetPointsMethodAtPlace(Place: Integer;
  PointsMethod: Int64; Valid: Boolean): Int64;
var
    req, resp: ISuperobject;
begin
    ...
    resp := Pipe_GetJsonrpcResult(pipe_conn,
      'LastParty.SetPointsMethodAtPlace', req);
...
class function TPlaceFirmware.CalculateFirmwareInfo(param1: Int64)
  : TFirmwareInfo;
var
    req, resp: ISuperobject;
begin
    ...
    resp := Pipe_GetJsonrpcResult(pipe_conn,
      'PlaceFirmware.CalculateFirmwareInfo', req);
...
begin
    ...
    resp := Pipe_GetJsonrpcResult(pipe_conn,
      'PlaceFirmware.RunReadPlaceFirmware', req);

end;

class procedure TPlaceFirmware.RunWritePlaceFirmware(Place: Integer;
  Year: Integer; Month: Integer; Day: Integer; Hour: Integer; Minute: Integer;
  Second: Integer; Sensitivity: string; Serial: string; ProductType: string;
  Gas: string; Units: string; ScaleBegin: string; ScaleEnd: string;
...
begin
    ...
    resp := Pipe_GetJsonrpcResult(pipe_conn,
      'PlaceFirmware.RunWritePlaceFirmware', req);
...
begin
    ...
    resp := Pipe_GetJsonrpcResult(pipe_conn,
      'PlaceFirmware.StoredFirmwareInfo', req);
...
begin
    ...
    resp := Pipe_GetJsonrpcResult(pipe_conn,
      'SettingsSvc.ChangePredefinedConfig', req);
...
begin
    ...
    resp := Pipe_GetJsonrpcResult(pipe_conn,
      'SettingsSvc.PredefinedConfig', req);
...
begin
    ...
    resp := Pipe_GetJsonrpcResult(pipe_conn,
      'SettingsSvc.SetDefaultPredefinedConfig', req);

    SuperObject_Get(resp, Result);

end;

class procedure TSettingsSvc.SetValue(param1: string; param2: string;
  param3: string);
var
    req, resp: ISuperobject;
begin
...
class procedure TRunnerSvc.RunReadCurrent(param1: Boolean; param2: Boolean;
  param3: Boolean; param4: Boolean; param5: Boolean; param6: Boolean;
  param7: Boolean; param8: Boolean; param9: Boolean; param10: Boolean;
  param11: Boolean; param12: Boolean);
var
...
class procedure TRunnerSvc.RunTemperature(param1: Boolean; param2: Boolean;
  param3: Boolean);
var
    req, resp: ISuperobject;
begin
...
begin
    ...
    resp := Pipe_GetJsonrpcResult(pipe_conn,
      'RunnerSvc.RunWritePartyFirmware', req);
...
class function TJournal.DayEntries(Year: Integer; Month: Integer; Day: Integer)
  : TArray<TJournalEntry>;
var
    req, resp: ISuperobject;
    i: ISuperobject;
begin
    ...
    begin
        ...
        Result[Length(Result) - 1] := TJson.JsonToObject<TJournalEntry>
          (i.AsJson);
...
class function TJournal.DayWorks(Year: Integer; Month: Integer; Day: Integer)
  : TArray<TJournalWork>;
var
    req, resp: ISuperobject;
    i: ISuperobject;
begin
    ...
    begin
        ...
        Result[Length(Result) - 1] := TJson.JsonToObject<TJournalWork>
          (i.AsJson);
