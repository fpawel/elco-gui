...
type 
    ...
    public
        class function Calculated( param1: Int64) : TFlashInfo;
...
class function TProductFirmware.Calculated( param1: Int64) : TFlashInfo;
var    
    req, resp: ISuperobject;
begin
    ensure_pipe_connected;
    ...
    resp := Pipe_GetJsonrpcResult(pipe_conn, 'ProductFirmware.Calculated', req);
    
        
             
                Result := TJson.JsonToObject < TFlashInfo > (resp.AsJson);
...
class function TProductFirmware.Stored( param1: Int64) : TFlashInfo;
var    
    req, resp: ISuperobject;
begin
    ensure_pipe_connected;
